...
model = dict(
    ...
    cls_head=dict(
        type='I3DHead',
        num_classes=19, # changed the no of classes 101 (UCF-101) to 6 (KTH)
        in_channels=4096,
        spatial_type=None,
        dropout_ratio=0.5,
        init_std=0.01,
...
load_from = "/home/ICTDOMAIN/d20125529/mmaction2-af_new/work_dirs/c3d_tubelet_dataset_focal_loss_config/best_acc_top1_epoch_26.pth"