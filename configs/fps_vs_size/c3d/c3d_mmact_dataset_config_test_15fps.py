...
data_root_val = F"{root_dir}/test_15fps"
data_root_test = F"{root_dir}/test_15fps"
split = 1  # official train/test splits. valid numbers: 1, 2, 3
ann_file_train = F"{root_dir}/train_annotations.txt"
ann_file_val = F"{root_dir}/test_15fps_annotations.txt"
ann_file_test = F"{root_dir}/test_15fps_annotations.txt"
...
model = dict(
    ...
    cls_head=dict(
        type='I3DHead',
        num_classes=37, # changed the no of classes 101 (UCF-101) to 6 (KTH)
        in_channels=4096,
        spatial_type=None,
        dropout_ratio=0.5,
        init_std=0.01,
