...
data_root_val = F"{root_dir}/test_10fps_160x120"
data_root_test = F"{root_dir}/test_10fps_160x120"
split = 1  # official train/test splits. valid numbers: 1, 2, 3
ann_file_train = F"{root_dir}/train_annotations.txt"
ann_file_val = F"{root_dir}/test_10fps_160x120_annotations.txt"
ann_file_test = F"{root_dir}/test_10fps_160x120_annotations.txt"
