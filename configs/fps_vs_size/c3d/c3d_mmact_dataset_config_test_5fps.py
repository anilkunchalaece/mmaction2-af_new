...
data_root_val = F"{root_dir}/test_5fps"
data_root_test = F"{root_dir}/test_5fps"
split = 1  # official train/test splits. valid numbers: 1, 2, 3
ann_file_train = F"{root_dir}/train_annotations.txt"
ann_file_val = F"{root_dir}/test_5fps_annotations.txt"
ann_file_test = F"{root_dir}/test_5fps_annotations.txt"
